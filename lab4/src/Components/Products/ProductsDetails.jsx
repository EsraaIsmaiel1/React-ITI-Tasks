...
export function ProductsDetails() {
  ...
  let { increase, addItemToCart } = value;
  ...
  return (
    <div className="container p-5 d-flex justify-content-center bg-light text-center">
      <div className="col-md-6 col-sm-4">
        ...
        <div className="cart-buttons m-3 ">
          <button
            ...
            className="btn btn-outline-info text-dark m-2"
            type="submit"
          >
